...
public class ClienteDAO {
    ...
    private static final String sqlinserir = "INSERT INTO clientes (id, nome, email, idade) VALUES (?, ?, ?, ?)";
    private static final String sqlalterar = "UPDATE clientes SET nome = ?, email = ?, idade = ? WHERE id = ?";
    ...
    public boolean Inserir(Cliente cli) {
        try {
            ...
            pstdados.setInt(4, cli.getIdade());
    ...
    public boolean Alterar(Cliente cli) {
       try {
            ...
            pstdados.setInt(3, cli.getIdade());
    ...
    public Cliente getCliente() {
        ...
        if (rsdados != null) {
            try {
                ...
                int idade = rsdados.getInt("idade");
                String email = rsdados.getString("email");
                cli = new Cliente(id, nome, idade, email);
            } catch (SQLException erro) {
