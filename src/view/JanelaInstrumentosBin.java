...
import controller.ControllerArquivoBinarioInstrumento;
 ...
 * @author Joao
 */
public class JanelaInstrumentosBin extends javax.swing.JFrame {
    
    ControllerArquivoBinarioInstrumento controle = new ControllerArquivoBinarioInstrumento();
    protected Instrumento instrumento = new Instrumento();
    
    /**
     * Creates new form JanelaCliente
     */
    public JanelaInstrumentosBin() {
    ...
    public void listarTab(){
        ...
        for(Instrumento i: controle.getInstrumentos()){
            modelo.insertRow(posLin, new Object[]{i.getId(), i.getNome(), i.getPreco(), i.getDescricao()});
            posLin++;
        }
    }
    ...
    private void jButtonGravarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonGravarMouseClicked
        controle.setInstrumento(
            jTextFieldNome.getText(),
            Double.valueOf(jTextFieldIdade.getText()),
            jTextFieldEmail.getText());
        
        controle.gravarInstrumento();
    ...
    private void BuscaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BuscaMouseClicked
        ...
        Instrumento i = controle.buscarInstrumento(id);
    ...
    private void EditaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditaMouseClicked
        ...
        controle.editarInstrumento(Integer.parseInt(jTextFieldId.getText()));
        listarTab(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaInstrumentosBin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaInstrumentosBin().setVisible(true);
            }
        });
    }
