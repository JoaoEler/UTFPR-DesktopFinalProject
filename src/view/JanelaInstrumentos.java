...
import controller.ControllerArquivoTextoInstrumento;
 ...
 * @author Joao
 */
public class JanelaInstrumentos extends javax.swing.JFrame {
    
    ControllerArquivoTextoInstrumento controle = new ControllerArquivoTextoInstrumento();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaInstrumentos().setVisible(true);
            }
        });
    }
