 ...
 * @author Joao
 */
public class JanelaClientesSQL extends javax.swing.JFrame {
    
    ClienteDAO dao = new ClienteDAO();
    private Cliente instrumento = new Cliente();
    
    /**
     * Creates new form JanelaCliente
     */
    public JanelaClientesSQL() {
    ...
    public void listarTab(){
        ...
        try{
            ...
            while(dao.getRsdados().next()){
                instrumento = dao.getCliente();
                modelo.insertRow(posLin, new Object[]{instrumento.getId(), instrumento.getNome(), instrumento.getIdade(), instrumento.getEmail()});
                posLin++;
            }
    ...
    private void jButtonGravarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonGravarMouseClicked
        ...
        instrumento.setIdade(Integer.valueOf(jTextFieldIdade.getText()));
        instrumento.setEmail(jTextFieldEmail.getText());
        
        Cliente cli = instrumento;
        if (dao.Inserir(cli)) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaClientesSQL().setVisible(true);
            }
        });
    }
