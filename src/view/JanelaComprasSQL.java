 ...
 * @author Joao
 */
public class JanelaComprasSQL extends javax.swing.JFrame {
    
    CompraDAO dao = new CompraDAO();
    private Compra instrumento = new Compra();
    
    /**
     * Creates new form JanelaCliente
     */
    public JanelaComprasSQL() {
    ...
    public void listarTab(){
        ...
        try{
            ...
            while(dao.getRsdados().next()){
                instrumento = dao.getCompra();
                modelo.insertRow(posLin, new Object[]{instrumento.getId(), instrumento.getProduto(), instrumento.getCliente(), instrumento.getPreco()});
                posLin++;
            }
    ...
    private void jButtonGravarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonGravarMouseClicked
        ...
        instrumento.setProduto(jTextFieldNome.getText());
        instrumento.setPreco(Double.valueOf(jTextFieldIdade.getText()));
        instrumento.setCliente(jTextFieldEmail.getText());
        
        Compra cli = instrumento;
        if (dao.Inserir(cli)) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaComprasSQL().setVisible(true);
            }
        });
    }
