...
import controller.ControllerArquivoBinarioCompra;
 ...
 * @author Joao
 */
public class JanelaComprasBin extends javax.swing.JFrame {
    
    ControllerArquivoBinarioCompra controle = new ControllerArquivoBinarioCompra();
    protected Compra instrumento = new Compra();
    
    /**
     * Creates new form JanelaCliente
     */
    public JanelaComprasBin() {
    ...
    public void listarTab(){
        ...
        for(Compra i: controle.getCompras()){
            modelo.insertRow(posLin, new Object[]{i.getId(), i.getProduto(), i.getPreco(), i.getCliente()});
            posLin++;
        }
    }
    ...
    private void BuscaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BuscaMouseClicked
        ...
        Compra i = controle.buscarCompra(id);
    ...
    private void EditaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditaMouseClicked
        ...
        controle.editarCompra(Integer.parseInt(jTextFieldId.getText()));
        listarTab(); 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaComprasBin().setVisible(true);
            }
        });
    }
