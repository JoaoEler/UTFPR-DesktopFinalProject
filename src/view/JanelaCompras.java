...
import controller.ControllerArquivoTextoCompra;
 ...
 * @author Joao
 */
public class JanelaCompras extends javax.swing.JFrame {
    
    ControllerArquivoTextoCompra controle = new ControllerArquivoTextoCompra();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaCompras().setVisible(true);
            }
        });
    }
